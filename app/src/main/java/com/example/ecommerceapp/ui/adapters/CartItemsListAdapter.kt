package com.example.ecommerceapp.ui.adapters
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        if(holder is MyViewHolder) {
            ...
            if(model.cart_quantity == "0") {
                ...
                holder.itemView.tv_cart_quantity.text = context.resources.getString(R.string.out_of_stock)
                ...
                holder.itemView.tv_cart_quantity.setTextColor(ContextCompat.getColor(context,R.color.black))
            }
